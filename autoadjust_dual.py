...
def read_loop():
    ...
    wrapper1 = UartWrapper(devname = '/dev/serial/by-id/usb-Silicon_Labs_CP2102_USB_to_UART_Bridge_Controller_0001-if00-port0')
    wrapper2 = UartWrapper(devname = '/dev/serial/by-id/usb-Silicon_Labs_CP2102_USB_to_UART_Bridge_Controller_0002-if00-port0')
    ...
    for i in range(len(red)):
        ...
        set_current(wrapper1, red_, white_)
        set_current(wrapper2, red_, white_)
